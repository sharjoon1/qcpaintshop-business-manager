...
// One-time migrate helper (remove after 20260808 migration applied)
router.post('/migrate-pending-table', requireAuth, requirePermission('products','manage'), async (req, res) => {
  try {
    await pool.query(`
